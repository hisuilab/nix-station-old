...
typeset -g POWERLEVEL9K_TERRAFORM_OTHER_BACKGROUND=$C_ACCENT

# ============================================================
# terraform_version: Terraform バージョン
# ============================================================
typeset -g POWERLEVEL9K_TERRAFORM_VERSION_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_TERRAFORM_VERSION_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=$C_PRIMARY
...
typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_AWS_EB_ENV_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND=$C_PRIMARY
# プロジェクト名取得前
...
typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_BACKGROUND=$C_PRIMARY
