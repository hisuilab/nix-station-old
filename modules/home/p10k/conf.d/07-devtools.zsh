...
typeset -g POWERLEVEL9K_ASDF_BACKGROUND=$C_PRIMARY
...
typeset -g POWERLEVEL9K_ASDF_RUBY_BACKGROUND=$C_LANG_WARM

typeset -g POWERLEVEL9K_ASDF_PYTHON_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_ASDF_PYTHON_BACKGROUND=$C_PRIMARY
...
typeset -g POWERLEVEL9K_ASDF_RUST_BACKGROUND=$C_ACCENT

typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_ASDF_DOTNET_CORE_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_ASDF_LUA_BACKGROUND=$C_PRIMARY

typeset -g POWERLEVEL9K_ASDF_JAVA_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_ASDF_JAVA_BACKGROUND=$C_ACCENT

typeset -g POWERLEVEL9K_ASDF_PERL_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_ASDF_PERL_BACKGROUND=$C_PRIMARY

typeset -g POWERLEVEL9K_ASDF_ERLANG_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_ASDF_ERLANG_BACKGROUND=$C_LANG_WARM

typeset -g POWERLEVEL9K_ASDF_ELIXIR_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_ASDF_ELIXIR_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_ASDF_PHP_BACKGROUND=$C_ACCENT

typeset -g POWERLEVEL9K_ASDF_HASKELL_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_ASDF_HASKELL_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=$C_PRIMARY
# Python バージョンは非表示
...
typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=$C_PRIMARY
typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${CONDA_PREFIX:t}}'

# pyenv
typeset -g POWERLEVEL9K_PYENV_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_PYENV_BACKGROUND=$C_PRIMARY
...
typeset -g POWERLEVEL9K_RUST_VERSION_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_RBENV_BACKGROUND=$C_LANG_WARM
...
typeset -g POWERLEVEL9K_RVM_BACKGROUND=$C_LANG_WARM
...
typeset -g POWERLEVEL9K_JAVA_VERSION_BACKGROUND=$C_ACCENT
typeset -g POWERLEVEL9K_JAVA_VERSION_PROJECT_ONLY=true
typeset -g POWERLEVEL9K_JAVA_VERSION_FULL=false

# jenv
typeset -g POWERLEVEL9K_JENV_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_JENV_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_PHP_VERSION_BACKGROUND=$C_ACCENT
typeset -g POWERLEVEL9K_PHP_VERSION_PROJECT_ONLY=true

# phpenv
typeset -g POWERLEVEL9K_PHPENV_FOREGROUND=$C_WHITE
typeset -g POWERLEVEL9K_PHPENV_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_DOTNET_VERSION_BACKGROUND=$C_ACCENT
...
typeset -g POWERLEVEL9K_PLENV_BACKGROUND=$C_PRIMARY
...
typeset -g POWERLEVEL9K_PERLBREW_BACKGROUND=$C_PRIMARY
...
typeset -g POWERLEVEL9K_LUAENV_BACKGROUND=$C_PRIMARY
...
typeset -g POWERLEVEL9K_SCALAENV_BACKGROUND=$C_LANG_WARM
...
typeset -g POWERLEVEL9K_HASKELL_STACK_BACKGROUND=$C_ACCENT
